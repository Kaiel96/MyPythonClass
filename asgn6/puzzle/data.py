...
class Finish: 
   ...
   def __eq__(self,other):
      return (epsilon_equal(self.ambiant, other.ambiant) and epsilon_equal(self.diffuse, other.diffuse) and 
         epsilon_equal(self.specular, other.specular) and epsilon_equal(self.roughness,other.roughness))
